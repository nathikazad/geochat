...
class ChatRoomsControllerTest < ActionController::TestCase
  ...
  test "should create chat_room" do
    assert_difference('ChatRoom.count') do
      post :create, chat_room: { latitude: @chat_room.latitude, longitude: @chat_room.longitude, nick_name: @chat_room.nick_name }
    end
  ...
  test "should update chat_room" do
    patch :update, id: @chat_room, chat_room: { latitude: @chat_room.latitude, longitude: @chat_room.longitude, nick_name: @chat_room.nick_name }
    assert_redirected_to chat_room_path(assigns(:chat_room))
  end
